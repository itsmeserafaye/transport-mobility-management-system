-- Create missing compliance records for operators without them
-- This script will create compliance_status records for any operator-vehicle pairs that don't have them

INSERT INTO compliance_status (compliance_id, operator_id, vehicle_id, franchise_status, inspection_status, violation_count, compliance_score)
SELECT 
