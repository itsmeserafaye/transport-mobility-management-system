...
switch ($format) {
    case 'csv':
        ...
        header('Content-Disposition: attachment; filename="violation_records_' . date('Y-m-d') . '.csv"');
    ...
    case 'excel':
        ...
        header('Content-Disposition: attachment; filename="violation_records_' . date('Y-m-d') . '.xls"');
    ...
    case 'pdf':
        ...
        header('Content-Disposition: attachment; filename="violation_records_' . date('Y-m-d') . '.html"');
        
        echo "<!DOCTYPE html><html><head><title>Violation Records Report</title></head><body>";
        echo "<h1>Violation Records Report</h1>";
