<?php
// Transport and Mobility Management System - TPRS Dashboard
...
<head>
    ...
    <title>TPRS Dashboard - Transport Management</title>
...
<body class="bg-slate-50 dark:bg-slate-900">
            ...
            <div class="bg-white border-b border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-md font-bold dark:text-white">TPRS DASHBOARD</h1>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Transport & Mobility Management System - TPRS Dashboard Loaded');
        });
    </script>
</body>
</html>