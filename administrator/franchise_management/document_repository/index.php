            ...
            <nav class="p-4 space-y-2">
                ...
                <div class="space-y-1">
                    ...
                    <div id="franchise-mgmt-menu" class="ml-8 space-y-1">
                        ...
                        <a href="../../franchise_management/document_repository/" class="block p-2 text-sm rounded-lg font-medium" style="color: #4CAF50; background-color: rgba(76, 175, 80, 0.2);">Document Repository</a>
            ...
            <div class="flex-1 p-6 overflow-auto">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-3">
                        <button onclick="openUploadModal()" class="px-4 py-2 text-white rounded-lg flex items-center space-x-2 transition-colors" style="background-color: #4CAF50;" onmouseover="this.style.backgroundColor='#45A049'" onmouseout="this.style.backgroundColor='#4CAF50'">
