    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            ...
            case 'update_recommendation':
                $result = updateRenewalRecommendation($conn, $_POST['vehicle_id'], $_POST['recommendation']);
                echo json_encode(['success' => $result]);
                break;
        }
    }
...
function updateRenewalRecommendation($conn, $vehicle_id, $recommendation) {
    // Log recommendation update
    error_log("Renewal recommendation updated for vehicle {$vehicle_id}: {$recommendation}");
    return true;
}
?>
...
<body style="background-color: #FBFBFB;" class="dark:bg-slate-900">
            ...
            <nav class="p-4 space-y-2">
                ...
                <div class="space-y-1">
                    ...
                    <div id="vehicle-inspection-menu" class="ml-8 space-y-1">
                        ...
                        <a href="../../vehicle_inspection_and_registration/inspection_history_tracking/" class="block p-2 text-sm rounded-lg font-medium" style="color: #4CAF50; background-color: rgba(76, 175, 80, 0.2);">History Tracking</a>
                    </div>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                'Review Required' => 'bg-red-100 text-red-800'
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <button onclick="updateRecommendation('<?php echo $renewal['vehicle_id']; ?>')" class="text-orange-600 hover:text-orange-900">Update</button>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Update Renewal Recommendation</h3>
                </div>
                <form id="updateForm" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="recommendation" id="recommendationSelect" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500" placeholder="Add any additional notes..."></textarea>
                    </div>
                    
                    <div class="flex justify-end space-x-3 pt-4">
                        <button type="button" onclick="closeModal('updateModal')" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200">
                            Cancel
                        </button>
                        <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-md hover:bg-orange-700">
    ...
    <script>
        ...
        function updateRecommendation(vehicleId) {
        ...
        document.getElementById('updateForm').addEventListener('submit', function(e) {
            ...
            formData.append('action', 'update_recommendation');
