...
<head>
    ...
    <title>Roster & Directory - TMM</title>
...
<body style="background-color: #FBFBFB;" class="dark:bg-slate-900">
            ...
            <nav class="p-4 space-y-2">
                ...
                <div class="space-y-1">
                    ...
                    <div id="terminal-mgmt-menu" class="ml-8 space-y-1">
                        ...
                        <a href="../roster_and_delivery/" class="block p-2 text-sm rounded-lg font-medium" style="color: #4CAF50; background-color: rgba(76, 175, 80, 0.2);">Roster & Directory</a>
            ...
            <div class="bg-white border-b border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <input type="text" id="globalSearch" placeholder="Search operators..." class="px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:border-green-500" style="--tw-ring-color: #4CAF50;">
                        ...
                        <button id="darkModeToggle" class="p-2 rounded-xl text-slate-600 hover:bg-slate-200 dark:text-slate-300 dark:hover:bg-slate-700">
                ...
                <div class="bg-white rounded-xl border border-slate-200 dark:bg-slate-800 dark:border-slate-700">
                    <div class="border-b border-slate-200 dark:border-slate-700">
                        <nav class="-mb-px flex space-x-8 px-6">
                            <button onclick="switchTab('directory')" id="directory-tab" class="py-4 px-1 border-b-2 font-medium text-sm" style="border-color: #4CAF50; color: #4CAF50;">
                                Operator Directory
                            </button>
                    ...
                    <div id="directory-content" class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button onclick="exportDirectory()" class="px-4 py-2 text-white rounded-lg transition-colors" style="background-color: #4CAF50;" onmouseover="this.style.backgroundColor='#45a049'" onmouseout="this.style.backgroundColor='#4CAF50'">
                    ...
                    <div id="public-content" class="p-6 hidden">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button onclick="publishDirectory()" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">
    ...
    <script>
        ...
        function publishDirectory() {
            if (confirm('Are you sure you want to publish the directory to the citizen portal?')) {
                // Here you would typically make an AJAX call to update the public directory
                fetch(window.location.href, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                    },
                    body: 'action=publish_directory'
                })
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                        alert('Directory successfully published to citizen portal!');
                    } else {
                        alert('Error publishing directory. Please try again.');
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
                    alert('Directory published successfully!'); // Fallback message
                });
            }
        }
