...
if ($compliance) {
    ...
    echo '<input type="number" name="compliance_score" min="0" max="100" step="0.1" value="' . $compliance['compliance_score'] . '" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-300">';
    echo '</div>';
    echo '<div>';
